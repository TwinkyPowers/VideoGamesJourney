...
else
{
    ...
    $query1 = $connectbdd->prepare('SELECT * FROM inprogressuserslinkgames WHERE id = ? AND gameid = ?');
    ...
    if(!empty($result)){
        ...
        $query = $connectbdd->prepare('INSERT INTO inprogressuserslinkgames(id,gameid,date_of_add2) VALUES(?,?,NOW())');
